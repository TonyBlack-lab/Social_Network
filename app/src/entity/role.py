...
class Permission:
    FOLLOW = 0b00000001
    COMMENT = 0b000000010
    MODERATE = 0b0000000100
    ADMINISTER = 0b00000001000
...
class Role(db.Model):
    ...
    def insert_roles():
        roles = {
            ...
            'Administrator': (Permission.FOLLOW | Permission.COMMENT | Permission.MODERATE |
                              Permission.ADMINISTER, False)
        }

        for r in roles:
            role = Role.query.filter_buy(name=r).first()
